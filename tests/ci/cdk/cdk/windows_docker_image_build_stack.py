...
from aws_cdk import core, aws_ec2 as ec2, aws_iam as iam, aws_ssm as ssm
from util.metadata import AWS_ACCOUNT, AWS_REGION, WINDOWS_ECR_REPO, S3_BUCKET_NAME, WIN_EC2_TAG_KEY, WIN_EC2_TAG_VALUE, \
    SSM_DOCUMENT_NAME
from util.iam_policies import ecr_power_user_policy_in_json
...
class WindowsDockerImageBuildStack(core.Stack):
    ...
    def __init__(self,
        ...
        placeholder_map = {"ECR_PLACEHOLDER": ecr_repo, "S3_BUCKET_PLACEHOLDER": S3_BUCKET_NAME,
